...
$jslink1 = new moodle_url($CFG->wwwroot.'/lib/editor/tinymce/tiny_mce/3.4.6/tiny_mce.js');
$jslink2 = new moodle_url($CFG->wwwroot.'/local/ualfrontpage/script/myeditor.js');
$csslink1 = new moodle_url($CFG->wwwroot.'/lib/editor/tinymce/tiny_mce/3.4.6/themes/advanced/skins/default/ui.css');
$csslink2 = new moodle_url($CFG->wwwroot.'/lib/editor/tinymce/tiny_mce/3.4.6/plugins/inlinepopups/skins/clearlooks2/window.css');
